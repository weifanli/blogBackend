...
import com.liweifan.common.utils.imp.CellRangeAddressWrapper;

public final class HSSFCopySheetUtil {
	public HSSFCopySheetUtil() {
	}
	...
	public static void copySheets(HSSFSheet newSheet, HSSFSheet sheet,
		...
		for (int i = sheet.getFirstRowNum(); i <= sheet.getLastRowNum(); i++) {
			...
			if (srcRow != null) {
				HSSFCopySheetUtil.copyRow(sheet, newSheet, srcRow, destRow,
						styleMap);
